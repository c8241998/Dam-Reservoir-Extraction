...
class Xception(object):
    ...
    def __call__(self, inputs, output_stages='c5', **kwargs):
        ...
        x = layers.MaxPooling2D((3, 3),
                                ...
                                padding='same',
                                name='block2_pool')(x)
        x = layers.add([x, residual],name='c1') 
        c1 = x
        ...
        if rm_pool:
            ...
            x = layers.MaxPooling2D((3, 3), strides=(2, 2),
                                    padding='same',
                                    name='block3_pool')(x)
        x = layers.add([x, residual],name='c2')
        c2 = x
        ...
        if rm_pool:
            ...
            x = layers.MaxPooling2D((3, 3), strides=(2, 2),
                                    padding='same',
                                    name='block4_pool')(x)
        x = layers.add([x, residual],name='c3')
        c3 = x
        ...
        for i in range(num_middle_flow):
            ...
            if i == num_middle_flow-1:
                x = layers.add([x, residual],name='c4')
            else:
        ...
        x = layers.Activation('relu', name='c5'.format(id=id + 1))(x) #block{id}_sepconv2_act
